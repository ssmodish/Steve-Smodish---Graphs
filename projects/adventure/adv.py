...
def explore_map():
    ...
    def travel_to(direction, prev_room_id):
    ...
    def explore_DFT():
        ...
        while '?' in world_map[player.currentRoom.id].values():
            # set last_room_id = current_room_id
            ...
            travel_to('w', prev_room_id)
            travel_to('n', prev_room_id)
            travel_to('e', prev_room_id)
            travel_to('s', prev_room_id)
        ...
        if backtrack_rooms is not None:
            ...
            while backtrack_path.qsize() > 0:
                ...
                print(f"Player backtracking to the {backtrack_direction}.")
